...
selffunction(zodiacSign);

function selffunction(x)
{
	...
	{
	  document.getElementById("textrow2").innerHTML=horo[1];	
	}
	else if(hs=="Gemini")
	{
		document.getElementById("textrow2").innerHTML=horo[2];
	}
	else if(hs=="Cancer")
	{
    document.getElementById("textrow2").innerHTML=horo[3];
		
	}
	else if(hs=="Leo")
	{
		document.getElementById("textrow2").innerHTML=horo[4];
	}
	else if(hs=="Virgo")
	{
    document.getElementById("textrow2").innerHTML=horo[5];
		
	}
	else if(hs=="Libra")
	{
		document.getElementById("textrow2").innerHTML=horo[6];
	}
	else if(hs=="Scorpio")
	{
	  document.getElementById("textrow2").innerHTML=horo[7];	
	}
	else if(hs=="Sagittarius")
	{
		document.getElementById("textrow2").innerHTML=horo[8];
	}
	else if(hs=="Capricor")
	{
		document.getElementById("textrow2").innerHTML=horo[9];
	}
	else if(hs=="Aquarius")
	{
		document.getElementById("textrow2").innerHTML=horo[10];
	}
	else if(hs=="Pisces")
	{
		document.getElementById("textrow2").innerHTML=horo[11];
	}	
